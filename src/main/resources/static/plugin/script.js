...
var arrLang = {
    'en': {
        ...
        'Input': 'Input',
        'Welcome': 'Welcome',
        'We': 'We are proud to show you a few of our recent projects',
        'Doc': 'Doctena is an online platform dedicated to help patients search for practitioners\n' +
            '                        (doctors, nurses) and organize appointments with them.',
        'Lot': 'LottieFiles is now used by animation and motion designers at 150,000 companies.',
        'But': 'A strategy game is a genre of computer games in which the player must\n' +
            '                        use strategic thinking to win.',
        'User': 'Users',
        'Logout': 'Logout',
        'Minsk':'Minsk ul.Nemiga 24',
    },
    'ru': {
        'Sign Up': 'Авторизация',
        'Input': 'Вход',
        'Welcome': 'Добро Пожаловать',
        'We': 'Мы рады показать вам несколько наших последних проектов',
        'Doc': 'Doctena — это онлайн-платформа, предназначенная для помощи пациентам в поиске практикующих врачей.\n' +
            '                        (врачи, медсестры) и организовывать встречи с ними.',
        'Lot': 'В настоящее время LottieFiles используется анимационными и моушн-дизайнерами в 150 000 компаний.',
        'But': 'Стратегия — жанр компьютерных игр, в которых игрок должен\n' +
            '                        используйте стратегическое мышление, чтобы победить.',
        'User': 'Пользователи ',
        'Logout': 'Выход',
        'Minsk': 'Минск ул.Немига 24',
    }
}
